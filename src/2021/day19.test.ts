import { createScanners, locateScanners, countBeacons, Scanner } from './day19';
...
describe('countBeacons', () => {
  it('correctly counts unique beacons for sample data', () => {
    const located = locateScanners(scanners);
    const count = countBeacons(located);
    expect(count).toEqual(79);
  });
});
